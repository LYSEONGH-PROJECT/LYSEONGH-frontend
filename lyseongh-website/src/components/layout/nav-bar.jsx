...
//                         <Link href={link.href} className={`hover:text-blue-600 -tracking-wider transition-colors font-semibold text-xl`}>
//                             {link.name}
//                         </Link>
//                     </NavigationMenuLink>
//                 </NavigationMenuItem>
...
//     useEffect(() => {
//         const handleScroll = () => {
//             setHideCompanyInfo(window.scrollY > 20);
//         }
...
//     return (
//         <header className={`w-full sticky top-0 shadow-sm z-50 overflow-hidden bg-white`}>
...
//                 <Link href="tel:+233543794580" className={`hidden md:flex items-center gap-x-2 hover:text-blue-600 transition-colors ease-out duration-300`}>
...
const CompanyInfo = ({ scrolled }) => (
    <div className={`hidden md:flex justify-between py-4 px-6 border-b transition-colors duration-500 ${scrolled ? 'bg-white  opacity-0 max-h-0' : 'bg-transparent opacity-100 max-h-100'}`}>
        <div className="flex justify-between gap-x-5">
